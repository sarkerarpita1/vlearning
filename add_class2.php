                ...
                <div class="card">
                    ...
                    <div class="body">
                        <ul class="nav nav-tabs padding-0">
                            <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#classlist"> Video Class list</a></li>
                            <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#addclass">Add Video Class</a></li>
                        </ul>                        
                    </div>
                </div>
                            ...
                            <div class="body">
                                <div class="row">
                                    ...
                                    <div class="col-sm-12">
									 ...
									 <div class="col-sm-12">
                                        <div class="form-group">
                                            <input type="text" value="" placeholder="Class Link" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <button class="btn btn-primary btn-lg btn-round btn-simple">Add Video Class</button>
                                    </div>
                                </div>
                            </div>
                        </div>
