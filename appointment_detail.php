            ...
            <div class="col-md-12 col-lg-4">
                <div class="card">
                    <div class="body">
                        ...
                        <h6>Student detail for appointment</h6>
                            ...
                            <table class="table table-hover m-t-20">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><strong class="col-green">2020/01/10</strong></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                        <a href="courses-info.html" class="btn btn-block btn-raised btn-primary btn-round waves-effect" role="button">Agree</a>
						 <a href="courses-info.html" class="btn btn-block btn-raised btn-primary btn-round waves-effect" role="button">Disagree</a>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    <div class="body">
                        <ul class="nav nav-tabs padding-0">
                            <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#Details">Appointment Details</a></li>
                            <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#Structure">Appointment Structure</a></li>
                            <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#Gallery">Appointment Gallery</a></li>
                        </ul>
                    </div>
                </div>
